...
def evaluate():
    ...
    model_close, scaler_close = load_model(model_dir, 'xgboost_close')
    ...
    model_returns, scaler_returns = load_model(model_dir, 'xgboost_returns')
